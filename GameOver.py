...
class GameOver():
    ...
    def __init__(this, screen, events, levelManager, time):
        ...
        this.button = Button(screen, events, this.levelManager, Command.LevelChange, 1, "Play Again?", screen.get_width()/2, 500, 200, 50, (100,250,100), (150,255,150), (75,225,75), (0,0,0), False, 11)
